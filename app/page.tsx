...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-white text-gray-800 font-sans overflow-hidden">
      <Sidebar 
        activePage={appState === 'history' ? 'history' : 'upload'} 
        ...
        <div className="flex-1 overflow-y-auto p-8 relative">
          ...
          {appState === 'loading' && (
            <div className="flex flex-col items-center justify-center h-full max-w-2xl mx-auto w-full">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Memproses Dokumen...</h2>
              ...
              {totalFiles > 1 ? (
                ...
                <p className="text-gray-500">AI sedang mengekstrak teks dan merangkum isi surat.</p>
              )}
            </div>
          )}
          ...
          {appState === 'success' && extractedDataList.length > 0 && (
            <div className="max-w-7xl mx-auto w-full h-full flex flex-col">
              ...
              <div className="flex items-center justify-between mb-8 shrink-0">
                ...
                <div className="flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full font-bold text-xs tracking-wider border border-green-100">
